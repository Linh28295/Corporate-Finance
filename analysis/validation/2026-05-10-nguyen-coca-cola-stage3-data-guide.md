...
Use the **full data reference** at `analysis/validation/2026-05-10-nguyen-coca-cola-financials-data-reference.md` for exact figures.
...
| `INC_net` | Net income (consolidated, = EBT − Tax = 13,137 in workbook; Mergent IS-line "Net Income attributable to KO" is 13,107 after $30M NCI deduction — see `2026-05-10-nguyen-coca-cola-financials-data-reference.md` reconciliation row) | 13,137 | 10,649 |
